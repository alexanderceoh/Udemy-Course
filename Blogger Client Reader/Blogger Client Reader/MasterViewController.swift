...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if let url = NSURL(string: "https://www.googleapis.com/blogger/v3/blogs/10861780/posts?key=AIzaSyCWzGSQDNcZh5dcsOTr2wKT69VZQ7XlF4Q") {
                    ...
                    do {
                        ...
                        if jsonResult.count > 0 {
                            ...
                            if let items = jsonResult["items"] as? NSArray {
                                ...
                                // we want to delete everything in coredata first
